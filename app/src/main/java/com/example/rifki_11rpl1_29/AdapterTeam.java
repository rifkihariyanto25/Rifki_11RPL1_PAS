...
public class AdapterTeam extends RecyclerView.Adapter<AdapterTeam.DatakuViewHolder> {
    ...
    public AdapterTeam(ArrayList<Model> dataList, Callback callback) {
    ...
    public void onBindViewHolder(final DatakuViewHolder holder, final int position) {
        ...
        holder.txtNpm.setText(dataList.get(position).getAlternate_name());
